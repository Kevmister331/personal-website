...
const Clients = () => (
  <section>
    <h2 className="font-poppins font-semibold xs:text-[48px] text-[40px] text-white xs:leading-[76.8px] leading-[66.8px] w-full px-30">Technology Stack</h2>
    <section className={`${styles.flexCenter} my-4`}>
      <div className={`flex flex-wrap justify-center ${styles.flexCenter} m-10`}>
        {clients.map((client) => (
          <div key={client.id} className="w-[30%] sm:w-[25%] md:w-[20%] flex-1 flex flex-col items-center py-2 px-2">
